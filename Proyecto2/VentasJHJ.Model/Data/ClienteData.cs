...
namespace VentasJHJ.Model.Data
{
    public class ClienteData
    {
        ...
        public Cliente Insertar(Cliente cliente)
        {
            ...
            cmdCliente.Parameters.Add(new SqlParameter("password_cliente", cliente.PasswordCliente));
        ...
        public List<Cliente> GetAll()
        {
            ...
            foreach (DataRow row in rows)
            {
                clientes.Add(new Cliente(Int32.Parse(row["id_cliente"].ToString()), row["nombre_cliente"].ToString(),
                    ...
                    row["password_cliente"].ToString(), row["direccion_cliente"].ToString(), row["telefono_cliente"].ToString()));
            }
            return clientes;
        }
    }
